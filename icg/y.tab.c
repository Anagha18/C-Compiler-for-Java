...
{
       0,    48,    48,    56,    57,    58,    59,    59,    59,    60,
      61,    61,    61,    61,    61,    63,    64,    65,    66,    67,
      69,    70,    71,    82,    85,    93,    99,   100,   101,   102,
     103,   104,   106,   115,   115,   131,   131,   139,   139,   148,
     152,   158,   160,   181,   181,   190,   197,   205,   208,   207
};
#endif
...
{
  "$end", "error", "$undefined", "VARIABLE", "NUMBER", "RELOP", "CLASS",
  "PSVM", "INT", "FLOAT", "CHAR", "DOUBLE", "LONG", "STRING", "UNARYPLUS",
  "UNARYMINUS", "IF", "ELSE", "WHILE", "FOR", "'+'", "'-'", "'*'", "'/'",
  "'('", "'{'", "'}'", "';'", "','", "'='", "')'", "$accept", "START",
  "PROGRAM1", "PROGRAM", "BLOCK", "CODE", "STATEMENT", "DECLARATIVE",
  "VARLIST", "ASSIGNMENT", "E", "CONDITIONAL", "$@1", "IFSTMT", "$@2",
  "ELSESTMT", "$@3", "CONDITION", "FORLOOP", "FORSTMT", "EXPRESSIONS",
  "$@4", "UNARY", "WHILELOOP", "WHILESTMT", "$@5", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,   266,   267,   268,   269,   270,   271,   272,   273,   274,
      43,    45,    42,    47,    40,   123,   125,    59,    44,    61,
      41
};
# endif
...
{
       1,     7,    16,   -40,    13,   -40,    23,    28,    29,     3,
     -40,   -40,    25,    53,    53,    53,    53,    53,    34,    35,
      36,   -40,    31,     3,    40,    41,   -40,    44,   -40,   -40,
     -40,   -40,     5,   -11,   -40,   -40,   -40,   -40,   -40,    59,
      59,    15,   -40,   -40,   -40,   -40,    46,   -40,   -40,     5,
      24,    53,    65,    66,    42,   -40,    43,    47,   -40,   -40,
      20,     5,     5,     5,     5,   -40,    45,    33,   -40,    48,
      59,    28,    28,   -40,    26,    26,   -40,   -40,    53,   -40,
     -40,    28,    28,   -40,   -40,   -40,   -40,   -40,   -40,    49,
      76,    37,   -40,   -40,   -40
};
...
static const yytype_uint8 yydefact[] =
{
       0,     0,     0,     2,     0,     1,     0,     0,     0,     0,
       4,     3,     0,     0,     0,     0,     0,     0,     0,     0,
       0,     6,     0,     8,     0,    14,    10,    32,    12,    41,
      11,    47,     0,    21,    15,    16,    17,    18,    19,     0,
       0,     0,     5,     7,     9,    13,     0,    30,    31,     0,
      24,     0,     0,     0,     0,    48,     0,     0,    37,    34,
       0,     0,     0,     0,     0,    20,    22,     0,    35,     0,
       0,     0,     0,    29,    25,    26,    27,    28,     0,    39,
      40,     0,     0,    43,    42,    38,    23,    36,    49,     0,
       0,     0,    44,    45,    46
};
...
{
     -40,   -40,   -40,   -40,    -7,    57,   -40,    50,   -12,   -40,
     -29,   -40,   -40,   -40,   -40,   -40,   -40,   -39,   -40,   -40,
     -40,   -40,   -40,   -40,   -40,   -40
};
...
{
      -1,     2,     3,     8,    21,    22,    23,    24,    34,    25,
      50,    26,    46,    27,    81,    59,    72,    54,    28,    29,
      57,    89,    92,    30,    31,    69
};
...
{
      10,    55,    35,    36,    37,    38,    12,     1,    47,    48,
       4,    13,    14,    15,    16,    17,     5,    51,    52,    18,
      60,    19,    20,    13,    14,    15,    16,    17,     9,    49,
       7,    83,    74,    75,    76,    77,    79,    80,     6,    65,
      61,    62,    63,    64,    61,    62,    63,    64,    63,    64,
      73,    93,    94,     9,    32,    11,    33,    42,    39,    40,
      41,   -33,    53,    58,    84,    85,    86,    44,    45,    66,
      70,    67,    68,    78,    87,    88,    90,    71,    82,    91,
...
{
       7,    40,    14,    15,    16,    17,     3,     6,     3,     4,
       3,     8,     9,    10,    11,    12,     0,    28,    29,    16,
      49,    18,    19,     8,     9,    10,    11,    12,    25,    24,
       7,    70,    61,    62,    63,    64,     3,     4,    25,    51,
      20,    21,    22,    23,    20,    21,    22,    23,    22,    23,
      30,    14,    15,    25,    29,    26,     3,    26,    24,    24,
      24,    17,     3,    17,    71,    72,    78,    27,    27,     4,
      27,     5,    30,    28,    81,    82,    27,    30,    30,     3,
...
{
       0,     6,    32,    33,     3,     0,    25,     7,    34,    25,
      35,    26,     3,     8,     9,    10,    11,    12,    16,    18,
      19,    35,    36,    37,    38,    40,    42,    44,    49,    50,
      54,    55,    29,     3,    39,    39,    39,    39,    39,    24,
      24,    24,    26,    36,    27,    27,    43,     3,     4,    24,
      41,    28,    29,     3,    48,    48,    38,    51,    17,    46,
      41,    20,    21,    22,    23,    39,     4,     5,    30,    56,
      27,    30,    47,    30,    41,    41,    41,    41,    28,     3,
       4,    45,    30,    48,    35,    35,    39,    35,    35,    52,
      27,     3,    53,    14,    15
};
...
{
       0,    31,    32,    33,    34,    35,    36,    36,    36,    37,
      37,    37,    37,    37,    37,    38,    38,    38,    38,    38,
      39,    39,    39,    39,    40,    41,    41,    41,    41,    41,
      41,    41,    42,    43,    42,    45,    44,    47,    46,    48,
      48,    49,    50,    52,    51,    53,    53,    54,    56,    55
};
...
#line 106 "parser.y" /* yacc.c:1646  */
    {   /* For single-IF statements, after the condition is evaluated, we push the starting index onto the stack.
...
#line 115 "parser.y" /* yacc.c:1646  */
    {    /* For IF-ELSE statements, we need two GOTO statements: One containing the snippet of code to jump tp
...
#line 160 "parser.y" /* yacc.c:1646  */
    { /* In a looping statement, you need two sets of indices; one to get out of the loop
...
#line 190 "parser.y" /* yacc.c:1646  */
    {
				  strcpy(QUAD[Index].operator,"+");
                        	  strcpy(QUAD[Index].operand1,"1");
                                  strcpy(QUAD[Index].operand2,(yyvsp[-1].arg));
                                  strcpy(QUAD[Index].result,(yyvsp[-1].arg));
